...
export default class GreetingCall extends Component {
    ...
    if(newName == "" || newName == null ){
      ...
      for (var i = 0; i < oldNames.length; i++) {
        if (
          ...
          isFound = true;
          this.setState({ errorMessage: "This user has already been added!", newName : "" });
        }
      }
  ...
  deleteUser = () => {
    ...
    if(index > -1){
      ...
      //var newArray = oldNames.splice((index-1), 1)
      ...
      this.setState({newName: "", errorMessage: "No user was found to delete!"})
    }
